...
def run_viewer(checkpoint: Path, label: str, seed: int = None):
    ...
    # Initialize engine temporarily to get input dimension
    ...
    def get_ppo_action(state: GameState) -> tuple[Action, Any]:
        """Get PPO action."""
        return _greedy_action(agent, translator, state)
    
    run_interactive_viewer(
        get_action_fn=get_ppo_action,
        label=label,
